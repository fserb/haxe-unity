...
class ComponentMethods {
  ...
  inline public inline static function getOrAddTypedComponent<T>(c:Component, type:Class<T>):T
    return GameObjectMethods.getOrAddTypedComponent(c.gameObject, type);

  inline public inline static function getChildGameObject(c:Component, name:String):GameObject
    return GameObjectMethods.getChildGameObject(c.gameObject, name);

  inline public inline static function getParentTypedComponent<T>(c:Component, type:Class<T>):T
